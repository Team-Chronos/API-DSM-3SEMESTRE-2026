// src/pages/ApontamentoTempo/TarefasInfo/ModalCadastro.tsx
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <input
                ...
                className={`border ${erroDataInicio ? "border-red-500" : "border-mist-700"} bg-mist-800 p-1.5 pl-3 rounded-lg`}
              />
              {erroDataInicio && <span className="text-red-500 text-sm">{erroDataInicio}</span>}
            </div>
            <div className="flex flex-col gap-y-2">
              ...
              />
              {erroDataFim && <span className="text-red-500 text-sm">{erroDataFim}</span>}
            </div>
            <div className="flex flex-col gap-y-2">
              ...
              />
              {erroDuracao && <span className="text-red-500 text-sm">{erroDuracao}</span>}
            </div>
          </div>
        </form>
      </div>
